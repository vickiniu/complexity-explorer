...
to setup
 ...
 set iteration 0
 output-print (word   "log 1/r     " "log N"  )  ; 1/r is the box size for any particular iteration, e.g. scale.
...
to linear-regression
 ...
 plotxy min(x-axis-list)  (min(x-axis-list) * slope + y-intercept)
 plotxy max(x-axis-list)  (max(x-axis-list) * slope + y-intercept)
    ]
   ]
end
@#$#@#$#@
...
1019
392
Fractal Dimension log N/log r (Hausdorff)
fractal-dim
17
1
11
...
189
613
monitors report variables for each iteration of box-count
11
0.0
1
...
1021
474
box-counting-dimension is the slope of the linear regression, compare with Fractal Dimension
11
0.0
1
...
189
495
amount that box length increases for each iteration
11
0.0
1
